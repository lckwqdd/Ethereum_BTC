...
public class CurrencyDetailAdapter extends RecyclerView.Adapter<CurrencyDetailAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public CurrencyDetailAdapter(Context context, List<CurrencyData> datas){
