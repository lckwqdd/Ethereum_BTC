...
import com.mirko.alsc.databinding.ActivityDevoteFxDetailBinding;
 ...
 * 分享明细
 */
public class DevoteFsDetailActivity extends AlscBaseActivity implements View.OnClickListener {


    private static final String TAG = "DevoteFsDetailActivity";
    ActivityDevoteFxDetailBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_devote_fx_detail);
    ...
    protected void setStatusBar() {
        StatusBarUtil.setColorNoTranslucent(DevoteFsDetailActivity.this, getResources().getColor(R.color.color_slide_bg));
    }
...
//        adapter.notifyDataSetChanged();
        ...
        }), DevoteFsDetailActivity.this, request));
