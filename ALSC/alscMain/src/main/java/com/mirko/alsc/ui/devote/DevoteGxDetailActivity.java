...
import com.mirko.alsc.adapter.DevoteDetailAdapter;
...
import com.mirko.alsc.databinding.ActivityDevoteGxDetailBinding;
import com.mirko.alsc.ui.capital.CurrencyDetailActivity;
 ...
 * 贡献明细
 */
public class DevoteGxDetailActivity extends AlscBaseActivity implements View.OnClickListener {


    private static final String TAG = "DevoteHomeActivity";
    ActivityDevoteGxDetailBinding binding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_devote_gx_detail);
    ...
    protected void setStatusBar() {
        StatusBarUtil.setColorNoTranslucent(DevoteGxDetailActivity.this, getResources().getColor(R.color.color_slide_bg));
    }
    ...
    private void getGxDetailDatas(int pageNo) {
        ...
        List<DevoteData> dataList = new ArrayList<>();

//        for(int i = 0;i<10;i++){
//            DevoteData data = new DevoteData();
//            data.setNumber_one("2012");
//            data.setNumber_two(123);
//            data.setNumber_three(123);
//            dataList.add(data);
//        }
//        devoteDatas.addAll(dataList);
//        adapter.notifyDataSetChanged();

        HttpManager.getInstance().doHttpDeal(new DevoteSharedInfoApi((new HttpOnNextListener<SharedResultEntity>() {

            @Override
            public void onNext(SharedResultEntity result) {
                LogUtils.d(TAG, "获取列表成功：");
                binding.tvTotal.setText(result.getTotal()+"");
        ...
        }), DevoteGxDetailActivity.this, request));
