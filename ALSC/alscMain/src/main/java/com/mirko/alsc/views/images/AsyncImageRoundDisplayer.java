...
/**
 * Created by Mirko on 2017/3/2.
 */

public class AsyncImageRoundDisplayer extends RoundedBitmapDisplayer {

    public AsyncImageRoundDisplayer(int cornerRadiusPixels) {
