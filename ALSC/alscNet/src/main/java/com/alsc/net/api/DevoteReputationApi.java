...
public class DevoteReputationApi extends BaseApi {

    private ListPageRequest request;

    public DevoteReputationApi(HttpOnNextListener<ReputationResultEntity> listener, RxAppCompatActivity rxAppCompatActivity, ListPageRequest request) {
    ...
    public Observable getObservable(HttpService methods) {
        ...
        return methods.devoteReputationInfo(body);
