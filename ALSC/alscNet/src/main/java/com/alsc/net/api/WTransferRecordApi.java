...
public class WTransferRecordApi extends BaseApi {

    private ListPageRequest request;

    public WTransferRecordApi(HttpOnNextListener<TransferRecordeEntity> listener, RxAppCompatActivity rxAppCompatActivity, ListPageRequest request) {
    ...
    public Observable getObservable(HttpService methods) {
        ...
        return methods.wTransferRecord(body);
