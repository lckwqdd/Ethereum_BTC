...
import com.alsc.net.retrofit.download.DownLoadListener.DownloadProgressListener;
import com.alsc.net.retrofit.download.DownState;
import com.alsc.net.retrofit.download.HttpDownManager;
import com.alsc.net.retrofit.listener.HttpDownOnNextListener;
