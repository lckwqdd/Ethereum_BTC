package com.mirko.androidutil.http;
...
public class HttpConfig {
    ...
    public static  int successCode = 3000;
    ...
    public static  String baseURL = "http://192.168.199.162:8080/";
...
//            crashHandler.init(application);
    ...
    private static void initFragmentation(int stackViewMode) {
        Fragmentation.builder()
                ...
                .debug(HttpConfig.isNetRequestInterceptor) // 实际场景建议.debug(BuildConfig.isNetRequestInterceptor)
                /**
