...
import com.mirko.androidutil.http.retrofit.progress.ProgressCancelListener;
import com.mirko.androidutil.view.loading.CommonLoading;
...
//  private ProgressDialogHandler mProgressDialogHandler;
  ...
  public ProgressSubscriber(SubscriberOnNextListener mSubscriberOnNextListener, Context context) {
    ...
    mCommonLoading = new CommonLoading(context, HttpConfig.loadingMessage);
  }
