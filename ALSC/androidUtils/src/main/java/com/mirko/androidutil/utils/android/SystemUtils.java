...
public class SystemUtils {
	...
	public static String getSysSdk() {
	    ...
	    LogUtils.i("AppSysMgr-->>getSysLanguage", sdkVersion);
	    return sdkVersion;
	}
	...
	public static String getSysLanguage() {
		...
		LogUtils.i("AppSysMgr-->>getSysLanguage",  language);
		return language;
	}
	...
	public static String getSysModel() {
		...
		LogUtils.i("AppSysMgr-->>getSysModel",  model);
		return model;
	}
	...
	public static String getSysRelease() {
		...
		LogUtils.i("AppSysMgr-->>getSysRelease",  release);
		return release;
	}
	...
	public static String getSysSIMSerialNum(Context content) {
		...
		LogUtils.i("AppSysMgr-->>getSysSIMSerialNum",  simSerialNumber);
    ...
    public static String getSysCPUSerialNum() {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.e("AppSysMgr-->>getSysCPUSerialNum",  e.getMessage().toString());
        }
        	return cpuSerialNum;
    }
	...
	public static String getSysTelephoneSerialNum(Context content) {
		...
		LogUtils.i("AppSysMgr-->>getSysTelephoneSerialNum",  deviceId + "");
		return deviceId;
	}
	...
	public static String getSysCarrier(Context content) {
		...
		LogUtils.i("AppSysMgr-->>getSysCarrier",  moblieType);
		return moblieType;
	}
	...
	public static String getSysDeviceSoftVersion(Context context) {
		...
		LogUtils.i("AppSysMgr-->>getSysDeviceSoftVersion",  deviceSoftwareVersion + "");
	...
	public static String getSysPhoneNumber(Context context) {
		...
		LogUtils.i("AppSysMgr-->>getSysPhoneNumber",  phoneNumber + "");
		return phoneNumber;
	}
	...
	public static String getSysSimCode(Context context) {
		...
		LogUtils.i("AppSysMgr-->>getSysSimCode",  code + "");
		return code;
	}
	...
	public static String getSysSimPrivatorName(Context context) {
		...
		LogUtils.i("AppSysMgr-->>getSysSimPrivatorName",  simOperatorName);
	...
	public static String getSysUserPhoneId(Context context) {
		...
		LogUtils.i("AppSysMgr-->>getSysUserPhoneId",  subscriberId);
		return subscriberId;
	}
	...
	public static DisplayMetrics getSysDisplayMetrics(Activity activity) {
		...
		LogUtils.i("AppSysMgr-->>getSysDisplayMetrics",  "获取屏幕管理对象为：" + displayMetrics);
	...
	public static int[] getScreenDispaly(Context context) {
		...
		LogUtils.i("AppSysMgr-->>getScreenDispaly-->>width",  "获取屏幕宽度为：" + width);
		LogUtils.i("AppSysMgr-->>getScreenDispaly-->>height",  "获取屏幕高度为：" + height);
    ...
    public static Integer getSysScreenWidth(Context context) {  
        ...
        LogUtils.i("AppSysMgr-->>getSysScreenWidth",  "获取屏幕宽度为：" + displayMetrics.widthPixels);
    ...
    public static Integer getSysScreenHeight(Context context)  {  
        ...
        DisplayMetrics displayMetrics = new DisplayMetrics();  
        wm.getDefaultDisplay().getMetrics(displayMetrics);  
        LogUtils.i("AppSysMgr-->>getSysScreenHeight",  "获取屏幕高度为：" + displayMetrics.heightPixels);
    ...
    public static Integer getSysScreenStatusHeight(Context context)  {  
        ...
        try {  
            ...
            LogUtils.i("AppSysMgr-->>getSysScreenStatusHeight",  "获取屏幕状态栏高度为：" + statusHeight);
        } catch (Exception e) {  
            e.printStackTrace();  
            LogUtils.e("AppSysMgr-->>getSysScreenStatusHeight",  "获取屏幕状态栏高度失败！" + e.getMessage());
        }  
        	return statusHeight;  
    } 
	...
	public static Integer getSysDefaultThreadPoolSize() {
		...
		LogUtils.i("AppSysMgr-->>getSysDefaultThreadPoolSize",  availableProcessors + "");
    ...
    public static Integer getSysSampleSize(BitmapFactory.Options options, int minSideLength, int maxNumOfPixels) {  
        ...
        LogUtils.i("AppSysMgr-->>getSysSampleSize",  roundedSize + "");
        return roundedSize;  
    }  
    ...
    public String getSysLocalIpAddress() {
        ...
        try {
        	...
        	e.printStackTrace();
        	LogUtils.e("AppSysMgr-->>getSysLocalIpAddress",  e.getMessage().toString());
        }
