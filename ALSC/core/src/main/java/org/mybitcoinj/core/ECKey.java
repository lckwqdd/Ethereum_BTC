...
import org.mybitcoin.NativeSecp256k1;
import org.mybitcoin.NativeSecp256k1Util;
import org.mybitcoin.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.mybitcoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws org.mybitcoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
