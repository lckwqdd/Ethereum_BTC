...
import org.mybitcoinj.utils.ListenerRegistration;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.mybitcoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.mybitcoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
