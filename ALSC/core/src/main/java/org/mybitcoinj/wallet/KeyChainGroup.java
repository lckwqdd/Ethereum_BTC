...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.mybitcoinj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.mybitcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.mybitcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
