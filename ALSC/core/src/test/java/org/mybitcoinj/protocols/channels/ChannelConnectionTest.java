...
package org.mybitcoinj.protocols.channels;

import org.mybitcoinj.core.*;
import org.mybitcoinj.protocols.channels.PaymentChannelClient.VersionSelector;
import org.mybitcoinj.script.ScriptPattern;
import org.mybitcoinj.testing.TestWithWallet;
import org.mybitcoinj.utils.Threading;
import org.mybitcoinj.wallet.Wallet;
import org.mybitcoinj.wallet.WalletExtension;
import org.mybitcoinj.wallet.WalletFiles;
...
import org.mybitcoin.paymentchannel.Protos;
...
import static org.mybitcoinj.protocols.channels.PaymentChannelClient.VersionSelector.*;
import static org.mybitcoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.mybitcoinj.testing.FakeTxBuilder.createFakeBlock;
import static org.mybitcoin.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.mybitcoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
